export default {
    ...
    "Status Pages": "Страницы мониторингов",
    Discard: "Отмена",
    ...
    "Also check beta release": "Проверять доступные бета-версии",
    "New Status Page": "Новая страница мониторинга",
    "Next": "Далее",
    "Accept characters": "Доступные символы",
};
